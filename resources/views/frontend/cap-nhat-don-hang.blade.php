                    ...
                    <form method="POST" action="{{ frontendRouter('account.order.update.post', ['id' => $order->id]) }}" name="form-checkout" enctype="multipart/form-data">
                        ...
                        <div class="form-row ">
                            <div class="form-col fl-left">
                                ...
                                <input type="text" name="name" placeholder="Nhập họ tên" value="{{ oldInput(old('name'), $order->name) }}" disabled>
                            </div>
                        </div>
                        <div class="form-row ">
                            <div class="form-col fl-left">
                                <label for="phone">Số điện thoại</label>
                                <input type="text" name="phone" placeholder="Nhập số điện thoại" value="{{ oldInput(old('phone'), $order->phone) }}" disabled>
                        ...
                        <div class="form-row">
                            <div class="form-col fl-left">
                                ...
                                <input type="text" name="address" placeholder="Nhập địa chỉ" value="{{ oldInput(old('address'), $order->address) }}" disabled>
                            </div>
                        </div>
