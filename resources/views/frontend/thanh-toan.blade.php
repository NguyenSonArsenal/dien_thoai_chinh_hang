                    ...
                    <form method="POST" action="{{ frontendRouter('thanh-toan.post') }}" name="form-checkout"
                        ...
                        <div class="form-row ">
                            <div class="form-col fl-left">
                                ...
                                <input type="text" name="name" placeholder="Nhập họ tên" value="{{ oldInput(old('name'), fE() ? fE()->username : '') }}" required>
                            </div>
                        </div>
                        <div class="form-row ">
                            <div class="form-col fl-left">
                                <label for="phone">Số điện thoại (*)</label>
                                <input type="text" name="phone" placeholder="Nhập số điện thoại" value="{{ oldInput(old('phone'), fE() ? fE()->phone : '') }}"
                                       required>
                        ...
                        <div class="form-row">
                            <div class="form-col fl-left">
                                ...
                                <input type="text" name="address" placeholder="Nhập địa chỉ" value="{{ oldInput(old('address'), fE() ? fE()->address : '') }}"
                                       required>
                            </div>
                        </div>
